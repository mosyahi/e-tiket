<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="../index.html">
        <div class="d-flex align-items-center"><img class="me-2" src="<?= base_url() ?>template/plugins/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span class="font-sans-serif">falcon</span>
        </div>
    </a>
                ...
                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Files</h6><a class="dropdown-item px-card py-2" href="#!">
                            <div class="d-flex align-items-center">
                                <div class="file-thumbnail me-2"><img class="border h-100 w-100 fit-cover rounded-3" src="<?= base_url() ?>template/plugins/assets/img/products/3-thumb.png" alt="" /></div>
                                <div class="flex-1">
                        ...
                        <a class="dropdown-item px-card py-2" href="#!">
                            <div class="d-flex align-items-center">
                                <div class="file-thumbnail me-2"><img class="img-fluid" src="<?= base_url() ?>template/plugins/assets/img/icons/zip.png" alt="" /></div>
                                <div class="flex-1">
                        ...
                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l status-online me-2">
                                    <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/1.jpg" alt="" />
                        ...
                        <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/2.jpg" alt="" />
                        ...
                        <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                            <div class="d-flex align-items-center">
                                <div class="avatar avatar-l me-2">
                                    <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/3.jpg" alt="" />
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                        ...
                        <div class="list-group list-group-flush fw-normal fs--1">
                                ...
                                <a class="notification notification-flush notification-unread" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/1-thumb.png" alt="" />
                            ...
                            <div class="list-group-item">
                                <a class="notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-2xl me-3">
                                            <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/icons/weather-sm.jpg" alt="" />
                                ...
                                <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-xl me-3">
                                            <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/logos/oxford.png" alt="" />
                            ...
                            <div class="list-group-item">
                                <a class="border-bottom-0 notification notification-flush" href="#!">
                                    <div class="notification-avatar">
                                        <div class="avatar avatar-xl me-3">
                                            <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/10.jpg" alt="" />
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/3-thumb.png" alt="" />
