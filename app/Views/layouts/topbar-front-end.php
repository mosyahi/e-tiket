        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-xl">
                    <?php if (session('role') == 1) : ?>
                        <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/2-thumb.png" alt="" />
                    <?php elseif (session('role') == 2) : ?>
                        <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/4-thumb.png" alt="" />
                    <?php else : ?>
                        <img class="rounded-circle" src="<?= base_url() ?>template/plugins/assets/img/team/5-thumb.png" alt="" />
                    <?php endif ?>
                </div>
            </a>
