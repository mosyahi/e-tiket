                    ...
                    <div class="col-8 col-sm-auto ms-auto text-end ps-0">
                        <div id="orders-actions">
                            <button class="btn btn-falcon-default btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#add">
                                ...
                                <span class="d-none d-sm-inline-block ms-1">Tambah Tiket</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            <?php $i = 1; ?>
                            <?php foreach ($tiket as $item) : ?>
                                <?php if ($item['jenis_tiket'] == '1' && $item['user_id'] == session('user_id')) : ?>
                                    <tr class="btn-reveal-trigger">
                                        <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                        <td class="order py-2 align-middle white-space-nowrap">
                                            <?php foreach ($biodata as $bio) : ?>
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            <?php $i = 1; ?>
                            <?php foreach ($tiket as $item) : ?>
                                <?php if ($item['jenis_tiket'] == '2' && $item['user_id'] == session('user_id')) : ?>
                                    <tr class="btn-reveal-trigger">
                                        <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                        <td class="order py-2 align-middle white-space-nowrap">
                                            <?php foreach ($biodata as $bio) : ?>
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            <?php $i = 1; ?>
                            <?php foreach ($tiket as $item) : ?>
                                <?php if ($item['jenis_tiket'] == '3' && $item['user_id'] == session('user_id')) : ?>
                                    <tr class="btn-reveal-trigger">
                                        <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                        <td class="order py-2 align-middle white-space-nowrap">
                                            <?php foreach ($biodata as $bio) : ?>
        ...
        <div class="modal-dialog modal-lg mt-6" role="document">
            <div class="modal-content border-0">
                ...
                <div class="modal-body py-4 px-5">
                    <form method="POST" action="<?= base_url('penjual/create-tiket') ?>" enctype="multipart/form-data">
                        <input type="hidden" name="user_id" value="<?= session('user_id') ?>">
                        <input type="hidden" name="biodata_id" value="<?= session('biodata_id') ?>">
                        <div class="mb-3">
        ...
        <div class="modal fade" id="edit-<?= $item['id_tiket'] ?>" tabindex="-1" role="dialog" aria-labelledby="add-label" aria-hidden="true">
            <div class="modal-dialog modal-lg mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body py-4 px-5">
                        <form method="POST" action="<?= base_url('penjual/update-tiket/' . $item['id_tiket']) ?>">
                            <input type="hidden" name="user_id" value="<?= session('user_id') ?>">
                            <input type="hidden" name="biodata_id" value="<?= session('biodata_id') ?>">
                            <div class="mb-3">
                                <label class="form-label" for="basic-form-email">Nama Tiket<span class="text-danger">*</span></label>
            ...
            <div class="modal-dialog mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" type="button" href="<?= base_url('penjual/delete-tiket/' . $item['id_tiket']) ?>">Hapus </a>
                    </div>
                </div>
            </div>
        </div>
