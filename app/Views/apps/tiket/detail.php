                            ...
                            <div class="mb-4 col-md-6 col-lg-4 mx-auto">
                                <div class="border h-100 d-flex flex-column justify-content-between pb-3 mt-3 mb-3" style="border-radius: 15px;">
                                    <div class="overflow-hidden">
                                        <div class="position-relative rounded-top overflow-hidden text-center mt-3"><a class="d-block" href="<?= current_url() ?>">
                                        ...
                                        <div class="p-3">
                                            <div class="text-center">
                                                <h5 class="fs-0"><a class="text-dark" href="<?= current_url() ?>"><?= $item['nama_tiket'] ?></a></h5>
    ...
    <?php if ($act == 'detail-tiket-darat') : ?>
        <div class="card mb-3 mt-3">
            <div class="card-body">
                <div class="row">
                    <?php foreach ($tiket as $item) : ?>
                        <?php if ($item['jenis_tiket'] == 1 && session('user_id') == $item['user_id']) : ?>
                            <div class="mb-4 col-md-6 col-lg-4 mx-auto">
                                <div class="border h-100 d-flex flex-column justify-content-between pb-3 mt-3 mb-3" style="border-radius: 15px;">
                                    <div class="overflow-hidden">
                                        <div class="position-relative rounded-top overflow-hidden text-center mt-3"><a class="d-block" href="<?= current_url() ?>">
                                    ...
                                    <div class="d-flex flex-between-center px-3">
                                        ...
                                        <div>
                                            <a class="btn btn-sm btn-falcon-default" href="<?= base_url('penjual/payment/' . $item['id_tiket'] . '/' . $item['nama_tiket'] . '/' . $item['jenis_transportasi']) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Pesan Sekarang"><span class="fas fa-shopping-cart"></span> Pesan E-Tiket</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php elseif ($act == 'detail-tiket-laut') : ?>
        <div class="card mb-3 mt-3">
            <div class="card-body">
                <div class="row">
                    <?php foreach ($tiket as $item) : ?>
                        <?php if ($item['jenis_tiket'] == 2 && session('user_id') == $item['user_id']) : ?>
                            <div class="mb-4 col-md-6 col-lg-4 mx-auto">
                                <div class="border h-100 d-flex flex-column justify-content-between pb-3 mt-3 mb-3" style="border-radius: 15px;">
                                    <div class="overflow-hidden">
                                        <div class="position-relative rounded-top overflow-hidden text-center mt-3"><a class="d-block" href="<?= current_url() ?>">
    ...
    <?php else : ?>
        <div class="card mb-3 mt-3">
            <div class="card-body">
                <div class="row">
                    <?php foreach ($tiket as $item) : ?>
                        <?php if ($item['jenis_tiket'] == 3 && session('user_id') == $item['user_id']) : ?>
                            <div class="mb-4 col-md-6 col-lg-4 mx-auto">
                                <div class="border h-100 d-flex flex-column justify-content-between pb-3 mt-3 mb-3" style="border-radius: 15px;">
                                    <div class="overflow-hidden">
                                        <div class="position-relative rounded-top overflow-hidden text-center mt-3"><a class="d-block" href="<?= current_url() ?>">
                            ...
                            <div class="mb-4 col-md-6 col-lg-4 mx-auto">
                                <div class="border h-100 d-flex flex-column justify-content-between pb-3 mt-3 mb-3" style="border-radius: 15px;">
                                    ...
                                    <div class="d-flex flex-between-center px-3">
                                        ...
                                        <div>
                                            <a class="btn btn-sm btn-falcon-default" href="<?= base_url('pembeli/payment/' . $item['id_tiket'] . '/' . $item['nama_tiket'] . '/' . $item['jenis_transportasi']) ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Pesan Sekarang"><span class="fas fa-shopping-cart"></span> Pesan E-Tiket</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
