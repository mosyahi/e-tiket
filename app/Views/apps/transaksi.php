                                ...
                                <?php foreach ($tiket as $t) : ?>
                                    <?php if ($t['id_tiket'] == $item['tiket_id'] && $t['jenis_transportasi'] == 1) : ?>
                                        <tr class="btn-reveal-trigger">
                                            ...
                                            <td class="order py-2 align-middle">MTICK-<?= $item['order_id'] ?></td>
                                            ...
                                            <td class="date py-2 align-middle">
                                                <?php if ('Success' == $item['status_pembayaran']) : ?>
                                                    <span class="badge badge rounded-pill badge-soft-success">SUCCESS</span>
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            ...
                            <?php foreach ($transaksi as $item) : ?>
                                <?php foreach ($tiket as $t) : ?>
                                    <?php if ($t['id_tiket'] == $item['tiket_id'] && $t['jenis_transportasi'] == 1 && session('user_id') == $item['user_id']) : ?>
                                        <tr class="btn-reveal-trigger">
                                            <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                            <td class="order py-2 align-middle">MTICK-<?= $item['order_id'] ?></td>
                                            <td class="date py-2 align-middle">
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            ...
                            <?php foreach ($transaksi as $item) : ?>
                                <?php foreach ($tiket as $t) : ?>
                                    <?php if ($t['id_tiket'] == $item['tiket_id'] && $t['jenis_transportasi'] == 2 && session('user_id') == $item['user_id']) : ?>
                                        <tr class="btn-reveal-trigger">
                                            <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                            <td class="order py-2 align-middle">MTICK-<?= $item['order_id'] ?></td>
                                            <td class="date py-2 align-middle">
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            ...
                            <?php foreach ($transaksi as $item) : ?>
                                <?php foreach ($tiket as $t) : ?>
                                    <?php if ($t['id_tiket'] == $item['tiket_id'] && $t['jenis_transportasi'] == 3 && session('user_id') == $item['user_id']) : ?>
                                        <tr class="btn-reveal-trigger">
                                            <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                            <td class="order py-2 align-middle">MTICK-<?= $item['order_id'] ?></td>
                                            <td class="date py-2 align-middle">
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                        ...
                        <tbody class="list" id="table-orders-body">
                            ...
                            <?php foreach ($transaksi as $item) : ?>
                                <?php foreach ($tiket as $t) : ?>
                                    <?php if ($t['id_tiket'] == $item['tiket_id'] && $t['jenis_transportasi'] == 5 && session('user_id') == $item['user_id']) : ?>
                                        <tr class="btn-reveal-trigger">
                                            <td class="order py-2 align-middle white-space-nowrap"><?= $i++; ?></td>
                                            <td class="order py-2 align-middle">MTICK-<?= $item['order_id'] ?></td>
                                            <td class="date py-2 align-middle">
        ...
        <div class="modal fade" id="hapus-<?= $item['id_transaksi'] ?>" tabindex="-1" role="dialog" aria-labelledby="add-label" aria-hidden="true">
            <div class="modal-dialog mt-6" role="document">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                        <a class="btn btn-primary" type="button" href="<?= base_url('penjual/transaksi/delete/' . $item['id_transaksi']) ?>">Hapus </a>
                    </div>
                </div>
            </div>
        </div>
